...
void* thread_tablero1(void *args)
{
  for (int i = 0; i < 10; i++) {
    for (int j = 0; j < 10; j++) {
...
void* thread_tablero2(void *args)
{
  for (int i = 0; i < 10; i++) {
    for (int j = 0; j < 10; j++) {
...
void* thread_tableroataque1(void *args)
{
  for (int i = 0; i < 10; i++) {
    for (int j = 0; j < 10; j++) {
...
void* thread_tableroataque2(void *args)
{
  for (int i = 0; i < 10; i++) {
    for (int j = 0; j < 10; j++) {
...
void imprimir_tablero(char tablero[][10])
{
    for (int n = 0; n < 10; n++) 
    {
      printf("   %d", n);
...
int main() 
{
  ...
  state1 = pthread_create(&thread_1, NULL, thread_tablero1, NULL);
  state2 = pthread_create(&thread_2, NULL, thread_tablero2, NULL);
  state3 = pthread_create(&thread_3, NULL, thread_tableroataque1, NULL);
  state4 = pthread_create(&thread_4, NULL, thread_tableroataque2, NULL);
